...
sed -i 's|# type_drivers = local,flat,vlan,gre,vxlan|type_drivers = flat,vxlan|g' /etc/neutron/plugins/ml2/ml2_conf.ini
sed -i 's|# tenant_network_types = local|tenant_network_types = flat,vxlan|g' /etc/neutron/plugins/ml2/ml2_conf.ini
...
sed -i 's|# vni_ranges =|vni_ranges = 100:500|g' /etc/neutron/plugins/ml2/ml2_conf.ini
